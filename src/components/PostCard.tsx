...
export default function PostCard({ post }: PostCardProps) {
  const imageUrl = `/images/blog/${post.slug}/${post.slug}-main-image.webp`;
  const excerpt = post.description.length > 100 ? post.description.substring(0, 100) + '...' : post.description;
